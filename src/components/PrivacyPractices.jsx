export default function PrivacyPractices() {
    return (
      <section className="px-4 sm:px-6 md:px-16 py-12 md:py-20 text-left">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4 md:mb-6">
          Privacy Practices
        </h1>
  
        <p className="text-gray-400 max-w-5xl leading-relaxed">
