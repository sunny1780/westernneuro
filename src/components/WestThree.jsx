          ...
          <motion.div className="text-left" variants={staggerContainer}>
            ...
            <motion.div className="flex flex-wrap gap-4" variants={staggerContainer}>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                transition={springBounce}
                className="inline-flex items-center gap-3 border border-[#94C6F1] text-[#1E5FBF] hover:bg-[#F3F8FF] font-medium px-6 py-2.5 rounded-full transition"
              >
                LinkedIn
                <span className="inline-flex items-center justify-center w-7 h-7 rounded-md border border-[#94C6F1] text-[#1E5FBF]">
